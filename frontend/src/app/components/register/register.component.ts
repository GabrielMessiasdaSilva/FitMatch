...
@Component({
  ...
  template: `
    <div class="min-h-screen flex items-center justify-center text-slate-100" style="background: linear-gradient(135deg, #000000ff 0%, #272529ff 50%, #ffffffff 100%);">
      <div class="w-full max-w-md bg-black/40 backdrop-blur-md rounded-3xl shadow-2xl border border-white/10 p-10 flex flex-col gap-8 animate-fade-in">
        ...
        <form [formGroup]="form" (ngSubmit)="submit()" class="flex flex-col gap-5">
          <div>
            ...
            <select formControlName="type" class="w-full px-5 py-3 rounded-xl bg-black/50 text-slate-100 border border-white/10 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition placeholder:text-slate-600">
          ...
          <div>
            ...
            <input formControlName="email" type="email" class="w-full px-5 py-3 rounded-xl bg-black/50 text-slate-100 border border-white/10 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition placeholder:text-slate-600" placeholder="Seu email" />
          ...
          <div>
            ...
            <input formControlName="password" type="password" class="w-full px-5 py-3 rounded-xl bg-black/50 text-slate-100 border border-white/10 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition placeholder:text-slate-600" placeholder="Sua senha" />
